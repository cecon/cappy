...
- **Script**: Obter via API de comando do VS Code. Chame `capybara.getNewTaskInstruction` (aliases: `cappy.getNewTaskInstruction`, `cappy-get-new-task-istruction`) e siga o TEXTO RETORNADO. Não leia arquivos diretamente.
