...
- pages/
  ...
  - knowledge-base/ — Documents (Knowledge Base) webview React page

Notes:
- The legacy folder `src/nivel1/webviews/` is deprecated and not referenced by the app. It will be removed.
- The app entry (`src/App.tsx`) renders `pages/chat` by default and `pages/knowledge-base` when the root element has `data-page="documents"`.
- Webview providers:
...
- [x] Move Documents page to `nivel1/ui/pages/knowledge-base/DocumentsPage.tsx`
