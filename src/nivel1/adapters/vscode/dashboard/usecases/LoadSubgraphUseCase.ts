...
export class LoadSubgraphUseCase implements UseCase {
  ...
  const indexingService = ctx.getIndexingService() as { graphStore?: { getSubgraph?: (seeds: string[] | undefined, depth: number) => Promise<{ nodes: unknown[]; edges: unknown[] }> } } | undefined;
